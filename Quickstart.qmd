...
- By **right-clicking** on an SA item, you can choose the **base specification**, in particular whether the series should be adjusted using:  
  - **TRAMO/SEATS**, or    
  - **X-13ARIMA-SEATS** (X-13).  
  
- By **left-clicking** on an SA item, you open the detailed, method-specific **specification editor**. Here you can set:  
...
These specifications can be saved and reused across series, ensuring consistent seasonal adjustment settings within and across projects.  
